...
//        val pipeline =
//            yamlMapper.readValue(step0Yaml, PipelineEntity::class.java)
//
//        val topicKeys = pipeline.topics.map { it.key }.toSet()
//        val expectedCount = pipeline.questionCount
//
...
//            pipelineId,
//            yamlMapper.writeValueAsString(mapOf("questions" to questions))
//        )
//
