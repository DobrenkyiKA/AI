...
class LongAnswersGenerationPipelineStepService(
    ...
    override fun getStepType(): StepType = StepType.LONG_ANSWERS_GENERATION

    override fun previousStepType(): StepType = StepType.QUESTIONS_GENERATION

    override fun inputStepType(): StepType = StepType.QUESTIONS_GENERATION

    override fun answerLabel(): String = "long answer"

    override fun totalCountLabel(): String = "totalAnswers"
