...
//
//    private val generator = mock(GoogleAiChatService::class.java)
...
//    private val service = TopicTreeGenerationStepService(generator, repository, artifactStorage, questionCatalogClient)
//
...
//        verify(artifactStorage).saveTopicTreeArtifact(eq(topicKey) ?: "", eq(pipelineName) ?: "", anyString() ?: "")
//        assertEquals(PipelineStatus.TOPIC_TREE_GENERATED, pipeline.status)
//
